...
# =========================================================================
# ফায়ারবেজ এডমিন কনফিগারেশন (সিকিউরিটি ব্লক এড়ানোর জন্য ভেরিয়েবল সেটআপ)
# =========================================================================
FIREBASE_DB_URL = os.environ.get("FIREBASE_DB_URL", "https://mino-sms-2c740-default-rtdb.firebaseio.com/")

# কোডের ভেতর সরাসরি প্রাইভেট কি না রেখে Vercel Environment Variable থেকে রিড করা হচ্ছে
CRED_DICT = {
"type": "service_account",
"project_id": "mino-sms-2c740",
"private_key_id": "a85ea572c42697fea434427351256de4ad047c44",
"private_key": os.environ.get("FIREBASE_PRIVATE_KEY"), # এই অংশটি Vercel থেকে অটো রিড হবে
...
if not firebase_admin._apps and CRED_DICT.get("private_key"):
 ...
 print("Warning: Firebase Credentials could not be loaded because FIREBASE_PRIVATE_KEY Environment Variable is missing.")
...
def register():
 try:
     ...
     user_data = {
         ...
         'email': email,
         'password': password,
         'api_key': '', # প্রথম রেজিস্ট্রেশনে ফাঁকা থাকবে
         'balance': 0.00,
         'otp_rate': 0.40,
         'wallet_address': '', 
